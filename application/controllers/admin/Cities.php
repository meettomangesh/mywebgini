...
class Cities extends CI_Controller {
    ...
    public function __construct() {
		...
		$this->load->model('admin/Model_cities');
    ...
    public function index() {
        ...
        $data['cities'] = $cities;
        $this->load->view('admin/vwManageCities',$data);
    }

    public function add_cities() {
        $data['page'] = 'cities';
        $this->load->view('admin/vwAddCities',$data);
    }

    public function edit_cities() {
        $data['page'] = 'cities';
        $this->load->view('admin/vwEditCities',$data);
    }
	public function view_Cities() {
        ...
        $data['cities'] = $cities;
        $this->load->view('admin/vwViewCities',$data);
    }
    ...
    public function get_statewise_cities() {
		...
		$city_data = '<select name="city_name" id="city_name" class="form-control">';
