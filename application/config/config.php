...
|
*/
//$config['base_url'] = 'http://crefitout.com/mywebgini/';
$config['base_url'] = 'http://localhost/mywebgini/';
...
define('HTTP_PROFILE_IMAGE_PATH', $config['base_url'].'assets/img/companies/');

define('HTTP_CSS_PATH_ADMIN', $config['base_url'].'assets/admin/css/');
define('HTTP_IMAGES_PATH_ADMIN', $config['base_url'].'assets/admin/img/');
