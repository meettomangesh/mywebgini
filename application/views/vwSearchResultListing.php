						  ...
						  <div class="card-stacked">
							<div class="card-content">
								<div class="com-info p-rel">
									...
									<div class="comp-pr"><?php if($profile->turn_over!=''){ ?><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $profile->turn_over; ?><?php if($profile->is_company_individual=='company'){ echo " Lacs"; } ?> <span><?php if($profile->is_company_individual=='individual'){ ?>Per Hour<?php }else{ ?>Per Year<?php } } ?></span></div>
								</div>
								<div class="short-des">
								...
								echo (isset($city_name[0])) ? $city_name[0] :''; ?></div>
							</div>
