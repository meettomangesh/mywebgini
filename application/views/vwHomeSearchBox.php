    ...
    <div class="container">
        <div class="search-hbox">
            ...
            <div id="simple_search_form">
                <form action="<?php echo base_url('search/simple_search'); ?>" method="post" name="search_form" id="search_form"> 
            ...
            <div id="advance_search_form" style="display:none;">
                <form action="<?php echo base_url('search/advance_search'); ?>" method="post" name="search_form" id="search_form"> 
                    <div class="search-inb wow fadeInUp" data-wow-delay="0.6s">
                        <div class="row mb-0">
                            <div class="input-field col s7">
                                <div class="rel">
            ...
            <div class="advance-search wow fadeInUp" data-wow-delay="0.6s">                  	
                ...
                <a id="simple_search_btn" class="btn right btn-large waves-effect" style="display:none;">Simple Search</a>
                <ul>
