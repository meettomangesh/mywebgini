...
<div class="container">	
        ...
        <form class="form-signin panel" method="post" action="<?php echo base_url(); ?>admin/change_password/update_password" style="max-width: 330px;padding: 15px;margin: 0 auto;" onsubmit="return check_validation();">
        ...
        <input type="text" class="form-control" placeholder="New password" name="new_password" id="new_password" autofocus required>
