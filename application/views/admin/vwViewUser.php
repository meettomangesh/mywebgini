        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td>Portfolio</td>
			  <td><?php 
				if(isset($user->portfolio_url) && $user->portfolio_url!=''){
					$portfolio_urls= explode("*#",$user->portfolio_url);
					$portfolio_descriptions= explode("*#",$user->portfolio_description);
					$i=0;
					foreach($portfolio_urls as $portfolio_url){
						echo "<a href='".$portfolio_url."' target='_blank'>".$portfolio_url."</a><br>".$portfolio_descriptions[$i]."<br><br>";
						$i++;
					}
				}
			   ?></td>
